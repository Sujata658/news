export const Newsss =
{
    ...
    "articles": [
        ...
        },
        {
            "id": "abcnewsau",
            "name": "ABC News (AU)",
            "description": "Australia's most trusted source of local, national and world news. Comprehensive, independent, indepth analysis, the latest business, sport, weather and more.",
        ...
        },
        {
            "id": "arynews",
            "name": "Ary News",
            "description": "ARY News is a Pakistani news channel committed to bring you uptothe minute Pakistan news and featured stories from around Pakistan and all over the world.",
        ...
        },
        {
            ...
            "description": "The AP delivers indepth coverage on the international, politics, lifestyle, business, and entertainment news.",
        ...
        {
            "id": "australianfinancialreview",
            "name": "Australian Financial Review",
            "description": "The Australian Financial Review reports the latest news from business, finance, investment and politics, updated in real time. It has a reputation for independent, awardwinning journalism and is essential reading for the business and investor community.",
        ...
        },
        {
            "id": "bbcnews",
            "name": "BBC News",
            "description": "Use BBC News for uptotheminute news, breaking news, video, audio and feature stories. BBC News provides trusted World and UK news as well as local and regional perspectives. Also entertainment, business, science, technology and health news.",
        ...
        },
        {
            ...
            "description": "Descubra a seção brasileira da Blasting News, a primeira revista feita pelo  público, com notícias globais e vídeos independentes. Juntese a nós e torne se um repórter.",
        ...
        },
        {
            ...
            "description": "Business Insider is a fastgrowing business site with deep financial, media, tech, and other industry verticals. Launched in 2007, the site is now the largest business news site on the web.",
        ...
        },
        {
            "id": "buzzfeed",
            "name": "Buzzfeed",
            "description": "BuzzFeed is a crossplatform, global network for news and entertainment that generates seven billion views each month.",
        ...
        },
        {
            "id": "cbcnews",
            "name": "CBC News",
            "description": "CBC News is the division of the Canadian Broadcasting Corporation responsible for the news gathering and production of news programs on the corporation's Englishlanguage operations, namely CBC Television, CBC Radio, CBC News Network, and CBC.ca.",
        ...
        },
        {
            "id": "espn",
            "name": "ESPN",
            "description": "ESPN has uptotheminute sports news coverage, scores, highlights and commentary for NFL, MLB, NBA, College Football, NCAA Basketball and more.",
        ...
        },
        {
            "id": "espncricinfo",
            "name": "ESPN Cric Info",
            "description": "ESPN Cricinfo provides the most comprehensive cricket coverage available including live ballbyball commentary, news, unparalleled statistics, quality editorial comment and analysis.",
        ...
        },
        {
            "id": "focus",
            "name": "Focus",
            "description": "Minutenaktuelle Nachrichten und ServiceInformationen von Deutschlands modernem Nachrichtenmagazin.",
        ...
        },
        {
            ...
            "url": "http://www.footballitalia.net",
            "category": "sports",
            "language": "en",
            "country": "it"
        },
        ...
        },
        {
            "id": "fourfourtwo",
            "name": "FourFourTwo",
            "description": "The latest football news, indepth features, tactical and statistical analysis from FourFourTwo, the UK&#039;s favourite football monthly.",
        ...
        },
        {
            "id": "googlenews",
            "name": "Google News",
            "description": "Comprehensive, uptodate news coverage, aggregated from sources all over the world by Google News.",
        ...
        },
        {
            ...
            "description": "Comprehensive, uptodate Australia news coverage, aggregated from sources all over the world by Google News.",
            "url": "https://news.google.com",
            "category": "general",
            "language": "en",
            "country": "au"
        ...
        },
        {
            ...
            "description": "Comprehensive, uptodate Canada news coverage, aggregated from sources all over the world by Google News.",
            "url": "https://news.google.com",
            "category": "general",
            "language": "en",
            "country": "ca"
        ...
        },
        {
            ...
            "description": "Comprehensive, uptodate India news coverage, aggregated from sources all over the world by Google News.",
            "url": "https://news.google.com",
            "category": "general",
            "language": "en",
            "country": "in"
        ...
        },
        {
            "id": "googlenewsuk",
            "name": "Google News (UK)",
            "description": "Comprehensive, uptodate UK news coverage, aggregated from sources all over the world by Google News.",
            "url": "https://news.google.com",
            "category": "general",
            "language": "en",
            "country": "gb"
        ...
        {
            "id": "goteborgsposten",
            "name": "GöteborgsPosten",
            "description": "GöteborgsPosten, abbreviated GP, is a major Swedish language daily newspaper published in Gothenburg, Sweden.",
            "url": "http://www.gp.se",
            "category": "general",
            "language": "sv",
            "country": "se"
        },
        {
            "id": "gruenderszene",
            "name": "Gruenderszene",
            "description": "OnlineMagazin für Startups und die digitale Wirtschaft. News und Hintergründe zu Investment, VC und Gründungen.",
        ...
        },
        {
            "id": "ign",
            "name": "IGN",
            "description": "IGN is your site for Xbox One, PS4, PC, WiiU, Xbox 360, PS3, Wii, 3DS, PS Vita and iPhone games with expert reviews, news, previews, trailers, cheat codes, wiki guides and walkthroughs.",
        ...
        },
        {
            "id": "mashable",
            "name": "Mashable",
            "description": "Mashable is a global, multiplatform media and entertainment company.",
        ...
        },
        {
            "id": "msnbc",
            "name": "MSNBC",
            "description": "Breaking news and indepth analysis of the headlines, as well as commentary and informed perspectives from The Rachel Maddow Show, Morning Joe & more.",
        ...
        },
        {
            "id": "newsweek",
            "name": "Newsweek",
            "description": "Newsweek provides indepth analysis, news and opinion about international issues, technology, business, culture and politics.",
        ...
        },
        {
            "id": "nhlnews",
            "name": "NHL News",
            "description": "The most uptodate breaking hockey news from the official source including interviews, rumors, statistics and schedules.",
        ...
        },
        {
            "id": "nrk",
            "name": "NRK",
            "description": "NRK er Norges største tilbud på nett: nyheter fra Norge og verden, lokalnyheter, radio og tvprogram, podcast, vær, helse, kultur, underholdning, humor og debattstoff.",
        ...
        },
        {
            "id": "rt",
            "name": "RT",
            "description": "Актуальная картина дня на RT: круглосуточное ежедневное обновление новостей политики, бизнеса, финансов, спорта, науки, культуры. Онлайнрепортажи с места событий. Комментарии экспертов, актуальные интервью, фото и видео репортажи.",
        ...
        },
        {
            "id": "t3n",
            "name": "T3n",
            "description": "Das OnlineMagazin bietet Artikel zu den Themen EBusiness, Social Media, Startups und Webdesign.",
            "url": "https://t3n.de",
            "category": "technology",
            "language": "de",
            "country": "de"
        ...
        },
        {
            "id": "thehindu",
            "name": "The Hindu",
            "description": "The Hindu. latest news, analysis, comment, indepth coverage of politics, business, sport, environment, cinema and arts from India's national newspaper.",
        ...
        },
        {
            "id": "theladbible",
            "name": "The Lad Bible",
            "description": "The LAD Bible is one of the largest community for guys aged 1630 in the world. Send us your funniest pictures and videos!",
        ...
        },
        {
            ...
            "description": "WSJ online coverage of breaking news and current headlines from the US and around the world. Top stories, photos, videos, detailed analysis and indepth reporting.",
        ...
        },
        {
            ...
            "description": "Breaking news and analysis on politics, business, world national news, entertainment more. Indepth DC, Virginia, Maryland news coverage including traffic, weather, crime, education, restaurant reviews and more.",
        ...
        },
        {
            ...
            "description": "Das OnlinePortal des führenden Wirtschaftsmagazins in Deutschland. Das Entscheidende zu Unternehmen, Finanzen, Erfolg und Technik.",
